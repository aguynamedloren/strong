...
ActiveRecord::Schema.define(version: 20160323103418) do
  ...
  add_index "routines", ["uuid"], name: "index_routines_on_uuid", unique: true, using: :btree
  ...
  add_index "workouts", ["uuid"], name: "index_workouts_on_uuid", unique: true, using: :btree
